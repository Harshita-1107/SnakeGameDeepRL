...
snake_body=pygame.image.load("snakeBody.png")
high_score=0
...
class Game():
    def __init__(self,width,height):
        ...
        self.bg = pygame.image.load("playground.png")
...
class Snake(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.snake_head=pygame.image.load("snakehead.png").convert()
...
class Food(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.prey=pygame.image.load("sungura.png")
...
if __name__=='__main__':
    weights_path='snake_weights.hdf5'
